...
# @application.route('/search_around_place', methods=['GET'])
...
# @application.route('/count_scale', methods=['GET'])
# def count_scale():
...
# @application.route('/search_scale', methods=['GET'])
# def search_scale():
...
# @application.route('/compare_two_place', methods=['GET'])
...
# @application.route('/largest_around_place', methods=['GET'])
